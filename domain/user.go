//go:generate mockgen -destination=../test/mock/domain/user_repository.go . UserRepository
//go:generate mockgen -destination=../test/mock/domain/user_service.go . UserService
package domain
